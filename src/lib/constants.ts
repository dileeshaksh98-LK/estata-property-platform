...
export const SITE = {
  ...
  description:
    'Buy, sell and rent land, houses and apartments across Sri Lanka on a live map - with nearby schools, hospitals and transport shown for every listing. Post free, contact sellers directly.',
